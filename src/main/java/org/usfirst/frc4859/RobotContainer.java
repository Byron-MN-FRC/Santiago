...
// Joysticks
private final XboxController xBoxDrive = new XboxController(1);
private final Joystick driveJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_driveTrain.setDefaultCommand(new DriveWithXBox( m_driveTrain ));
...
// Create some buttons
final JoystickButton xBoxShiftDown = new JoystickButton(xBoxDrive, XboxController.Button.kRightBumper.value);        
xBoxShiftDown.onTrue(new ShiftDownCommand( m_shift ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton xBoxShiftUp = new JoystickButton(xBoxDrive, XboxController.Button.kLeftBumper.value);        
xBoxShiftUp.onTrue(new ShiftUpCommand( m_shift ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
